========================================================================
    KONSOLENANWENDUNG: opencl-tutorial-Projektübersicht
========================================================================

Diese opencl-tutorial-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre opencl-tutorial-Anwendung besteht.


opencl-tutorial.vcxproj
...
opencl-tutorial.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen opencl-tutorial.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
