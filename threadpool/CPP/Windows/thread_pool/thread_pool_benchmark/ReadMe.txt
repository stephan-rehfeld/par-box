========================================================================
    KONSOLENANWENDUNG: thread_pool_benchmark-Projektübersicht
========================================================================

Diese thread_pool_benchmark-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre thread_pool_benchmark-Anwendung besteht.


thread_pool_benchmark.vcxproj
...
thread_pool_benchmark.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen thread_pool_benchmark.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
