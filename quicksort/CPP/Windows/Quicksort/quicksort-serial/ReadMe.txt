========================================================================
    KONSOLENANWENDUNG: quicksort-serial-Projektübersicht
========================================================================

Diese quicksort-serial-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre quicksort-serial-Anwendung besteht.


quicksort-serial.vcxproj
...
quicksort-serial.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen quicksort-serial.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
