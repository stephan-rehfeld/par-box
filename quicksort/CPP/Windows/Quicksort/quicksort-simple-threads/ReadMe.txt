========================================================================
    KONSOLENANWENDUNG: quicksort-simple-threads-Projektübersicht
========================================================================

Diese quicksort-simple-threads-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre quicksort-simple-threads-Anwendung besteht.


quicksort-simple-threads.vcxproj
...
quicksort-simple-threads.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen quicksort-simple-threads.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
